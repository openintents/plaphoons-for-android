...
public class SampleTalkCollection {
	...
	static {
		acceuil.setInfos(new TalkInfo[] {
				new TalkInfo("Personnes", "personnes", Color.YELLOW, personnes1, R.drawable.personne), //
				new TalkInfo(), //
				new TalkInfo("Les Couleurs", "les couleurs", Color.BLACK, couleurs, R.drawable.couleurs), //
				new TalkInfo(), //
				new TalkInfo(), //
				new TalkInfo("Boire", "boire", Color.GREEN, boire, R.drawable.boire1) }, //
				...
				new TalkInfo[] { new TalkInfo("Encore", Color.BLACK, R.drawable.encore), //
		...
		personnes1.setInfos(new TalkInfo[] {
				...
				new TalkInfo[] {
						...
						new TalkInfo(), //
						new TalkInfo(), //
						new TalkInfo(null, null, Color.BLACK, acceuil, R.drawable.retourner) });
	...
	boire.setInfos(
			new TalkInfo[] {
					...
					new TalkInfo("Jus à la Fraise", "un jus à la Fraise"), //
					new TalkInfo(), //
					new TalkInfo(), //
					new TalkInfo(), //
					new TalkInfo("Je veux", "je veux", Color.BLUE, null, R.drawable.je_veux) }, //

			new TalkInfo[] { new TalkInfo("Soupe","de la Soupe", Color.BLACK,null, R.drawable.soupe), //
					new TalkInfo("Eau", "de l'Eaux", Color.BLACK, null, R.drawable.c), //
					new TalkInfo("Lait", "du lait", Color.BLACK, null, R.drawable.lait1), //
					new TalkInfo("Grenadine","de la Grenadine", Color.BLACK, null, R.drawable.koolade), //
					new TalkInfo("Menthe", "de la Menthe", Color.BLACK, null, R.drawable.menthe), //
					new TalkInfo() }, //

			new TalkInfo[] { new TalkInfo(), //
					new TalkInfo(), //
					new TalkInfo("Cacao", " Du Cacao", Color.BLACK,  null, R.drawable.chocolat_au_lait), //
					new TalkInfo("Jus d'Orange", "Du Jus d'Orange", Color.BLACK, null, R.drawable.jus_d_orange), //
					new TalkInfo("Boite de Jus", "un petit jus", Color.BLACK, null, R.drawable.boite_de_jus), // 
					new TalkInfo()},

			new TalkInfo[] { new TalkInfo(), //				
					new TalkInfo("Encore", "encore", Color.BLACK, null, R.drawable.encore), //
					new TalkInfo("Stop", "stop", Color.BLACK, null, R.drawable.arreter), //
					new TalkInfo("Merci", "merci", Color.BLACK, null, R.drawable.merci), //
					new TalkInfo(), //
					new TalkInfo(null, null, Color.BLACK, acceuil, R.drawable.retourner) });
	...
	couleurs.setInfos(
			new TalkInfo[] {
					new TalkInfo("Bleu", "bleu", Color.BLACK, null, R.drawable.bleu), //
					new TalkInfo("Rouge", "rouge", Color.BLACK, null, R.drawable.rouge), //
					new TalkInfo("Blanc", "blanc", Color.BLACK, null, R.drawable.blanc), //
					new TalkInfo(), //
					new TalkInfo(), //
					new TalkInfo() }, //

			new TalkInfo[] { new TalkInfo("Rose", "rose", Color.BLACK, null, R.drawable.rose), //
					new TalkInfo("Brun", "brun", Color.BLACK, null, R.drawable.brun), //
					new TalkInfo(), //
					new TalkInfo(), //
					new TalkInfo(), //
					new TalkInfo() }, //
